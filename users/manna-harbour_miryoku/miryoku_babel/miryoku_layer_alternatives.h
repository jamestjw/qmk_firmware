...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    E_ACU,             TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    E_GRV,             TD(U_TD_U_BASE),   U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
